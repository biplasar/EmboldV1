...
var options = {
  ...
  'url': 'http://sipembold.eastus.cloudapp.azure.com:7790/api/v1/repositories',
  /*'headers': {
...
getRepositoryCodeIssueList: (req, res) => {
  request({'method': 'GET', 'url': 'http://sipembold.eastus.cloudapp.azure.com:7790/api/v1/repositories/' + req.params.repositoryUID + '/issues/codeissues/details', 'headers': {
    'Authorization': 'Bearer eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTY4MDYwMDQ4MDkzMCwiaWF0IjoxNjgwNjAwNDgwfQ.5-RIW5VrXEZ_bYuWDu1zL0DuNljZWVIgrHOMYcm8mlCgsnFhqDh8tBx48kUKcOthdpv8b5m0JVoQAsjcpqxT-A'
  }}, function (error, response) {
      if (error) throw new Error(error);
      console.log(response.body);
...
performScan: (req, res) => {
  request({'method': 'POST', 'url': 'http://sipembold.eastus.cloudapp.azure.com:7790/api/v1/repositories/' + req.params.repositoryUID + '/scan', 'headers': {
    'Authorization': 'Bearer eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTY4MDYwMDQ4MDkzMCwiaWF0IjoxNjgwNjAwNDgwfQ.5-RIW5VrXEZ_bYuWDu1zL0DuNljZWVIgrHOMYcm8mlCgsnFhqDh8tBx48kUKcOthdpv8b5m0JVoQAsjcpqxT-A'
  }}, function (error, response) {
      if (error) throw new Error(error);
      console.log(response.body);
